...
const buttonVariants = cva(
  "inline-flex font-josefine-sans border-2 border-[#ffffff59] items-center justify-center gap-2 whitespace-nowrap rounded-xl transition-all disabled:cursor-not-allowed disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive text-neutral-050 active:text-neutral-300 disabled:text-neutral-500",
  {
    variants: {
      variant: {
        default:
